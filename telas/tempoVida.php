...
<head>
    ...
    <title>Exibindo o tempo de vida da pessoa ate 100 anos</title>
</head>
<body>
    <form method="POST" style="background-color: #f0f4ff; text-align:center; margin: 3%; padding:5%">
        <h1>EXIBINDO O TEMPO DE VIDA ATÉ 100 ANOS</h1>
        <br>
        <div class="mb-3">
            <label for="lPrimeiroNumero" class="form-label">Informe sua idade</label>
