...
<head>
    ...
    <title>Converter celsius em fahrenheit</title>
</head>
<body>
    <form method="POST" style="background-color: #f0f4ff; text-align:center;margin:3%; padding:5%">
        ...
        <br>
        <div class="mb-3">
            <label for="lPrimeiroNumero" class="form-label">Informe a temperatura em celsius</label>
        ...
        <?php
            ...
            {
                $celsius = (float) $_POST['primeiroNumero'];
            }
        ?>
        <h3>
            <?php
